...
export default function AdminInterviews() {
              ...
              <tbody>
                {slots.map((s) => (
                  ...
                  >
                    ...
                    <td className="mono">
                      {new Date(s.start_time_utc).toLocaleString()}
                    </td>
                    <td className="mono">
                      {new Date(s.end_time_utc).toLocaleString()}
                    </td>
                    ...
                    <td>
                      <button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          window.open(s.resume_url, "_blank");
                        }}
                      >
                        Resume
                      </button>
        ...
        <div className="modal-overlay" onClick={() => setShowModal(false)}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <p>
                <strong>Experience:</strong> {selectedSlot.experience}
              </p>
              <p>
                <strong>Start:</strong>{" "}
              ...
              <p>
                <strong>End:</strong>{" "}
                {new Date(selectedSlot.end_time_utc).toLocaleString()}
              </p>
              <p>
                <strong>Payment:</strong>{" "}
                {selectedSlot.is_payment_done ? "Paid" : "Free"}
              </p>
              <p>
                <strong>Skills:</strong> {(selectedSlot.skills || []).join(", ")}
              </p>
              <p>
                <a
                  href={selectedSlot.resume_url}
                  target="_blank"
                  rel="noreferrer"
                  className="action-btn"
                >
  ...
  return (
    <AdminLayout headerTitle="Interviews" headerSubtitle="Filter by date and mode">
      {content}
    </AdminLayout>
  );
}
